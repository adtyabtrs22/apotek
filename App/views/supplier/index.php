...
<body>
    ...
    <center><h2>Manajemen Supplier</h2></center>
        <a href="<?php echo BASE_URL; ?>/supplier/create" class="button">Tambah Supplier Baru</a>
        <table>
            <thead>
                <tr>
                    <th>ID Supplier</th>
            ...
            <tbody>
                <?php foreach($data['supplier'] as $supplier): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($supplier['email_supplier']); ?></td>
                        <td>
                            <a href="<?php echo BASE_URL; ?>/supplier/edit/<?php echo $supplier['id_supplier']; ?>">Edit</a> |
                            <a href="<?php echo BASE_URL; ?>/supplier/delete/<?php echo $supplier['id_supplier']; ?>" 
                               onclick="return confirm('Apakah Anda yakin ingin menghapus supplier ini?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php if(empty($data['supplier'])): ?>
                    <tr>
                        <td colspan="6">Tidak ada data supplier.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
