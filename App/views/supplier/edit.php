...
<head>
    ...
    <title>Edit Supplier - Apotek</title>
   ...
   <div class="sidebar" style="margin-top: 20px;">
    ...
    <div class="content">
        <div class="form-container">
            <h2>Edit Supplier</h2>
            <form method="POST" action="<?php echo BASE_URL; ?>/supplier/edit/<?php echo $data['supplier']['id_supplier'] ?? ''; ?>">
                <label for="nama_supplier">Nama Supplier:</label>
                <input type="text" name="nama_supplier" value="<?php echo htmlspecialchars($data['supplier']['nama_supplier'] ?? ''); ?>" required>

                <label for="alamat_supplier">Alamat Supplier:</label>
                <textarea name="alamat_supplier" rows="4" required><?php echo htmlspecialchars($data['supplier']['alamat_supplier'] ?? ''); ?></textarea>

                <label for="kontak_supplier">Kontak Supplier:</label>
                <input type="text" name="kontak_supplier" value="<?php echo htmlspecialchars($data['supplier']['kontak_supplier'] ?? ''); ?>" required>

                <label for="email_supplier">Email Supplier:</label>
                <input type="email" name="email_supplier" value="<?php echo htmlspecialchars($data['supplier']['email_supplier'] ?? ''); ?>" required>
