...
<head>
    ...
    <title>Edit Satuan - Apotek</title>
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            <h2>Edit Satuan</h2>
            <form method="POST" action="<?php echo BASE_URL; ?>/satuan/edit/<?php echo $data['satuan']['id_satuan']; ?>">
                <label for="satuan">Nama Satuan:</label>
                <input type="text" name="satuan" value="<?php echo htmlspecialchars($data['satuan']['satuan']); ?>" required>

                <button type="submit"><i class="fas fa-save"></i> Update Satuan</button>
            </form>
        </div>
    </div>
