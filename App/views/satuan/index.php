...
<head>
    ...
    <title>Master Data Satuan - Apotek</title>
...
<body>
    ...
    <center><h2>Master Data Satuan</h2></center>
        <a href="<?php echo BASE_URL; ?>/satuan/create" class="button">Tambah Satuan Baru</a>
        <table>
            <thead>
                <tr>
                    <th>ID Satuan</th>
            ...
            <tbody>
                <?php foreach($data['satuan'] as $satuan): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($satuan['id_satuan']); ?></td>
                        <td><?php echo htmlspecialchars($satuan['satuan']); ?></td>

                        <td>
                            <a href="<?php echo BASE_URL; ?>/satuan/edit/<?php echo $satuan['id_satuan']; ?>">Edit</a> |
                            <a href="<?php echo BASE_URL; ?>/satuan/delete/<?php echo $satuan['id_satuan']; ?>" 
                               onclick="return confirm('Apakah Anda yakin ingin menghapus satuan ini?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php if(empty($data['satuan'])): ?>
                    <tr>
                        <td colspan="7">Tidak ada data satuan.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
