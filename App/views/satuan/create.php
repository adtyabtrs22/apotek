...
<head>
    ...
    <title>Tambah Satuan - Apotek</title>
   ...
   <div class="sidebar" style="margin-top: 20px;">
    ...
    <div class="content">
        <div class="form-container">
            <h2>Tambah Satuan</h2>
            <form method="POST" action="<?php echo BASE_URL; ?>/satuan/create">
                <label for="satuan">Nama Satuan:</label>
                <input type="text" name="satuan" placeholder="Masukkan nama satuan" required>

                <button type="submit"><i class="fas fa-save"></i> Tambah Satuan</button>
            </form>
        </div>
    </div>
