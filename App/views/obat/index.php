...
<body>
    ...
    <center><h2>Manajemen Obat</h2></center>
        <a href="<?php echo BASE_URL; ?>/obat/create" class="button">Tambah Obat Baru</a>
        <table>
            <thead>
                <tr>
                    <th>ID Obat</th>
            ...
            <tbody>
                <?php foreach($data['obat'] as $obat): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($obat['id_obat']); ?></td>
                        <td><?php echo htmlspecialchars($obat['nama_obat']); ?></td>
                        <td><?php echo htmlspecialchars($obat['jenis_obat']); ?></td>
                        <td><?php echo htmlspecialchars($obat['kategori']); ?></td>
                        <td><?php echo htmlspecialchars($obat['satuan']); ?></td>
                        <td><?php echo htmlspecialchars($obat['tanggal_kedaluwarsa']); ?></td>
                        <td><?php echo htmlspecialchars($obat['stok']); ?></td>
                        <td><?php echo htmlspecialchars($obat['stok_minimal']); ?></td>
                        <td>
                            <a href="<?php echo BASE_URL; ?>/obat/edit/<?php echo $obat['id_obat']; ?>">Edit</a> |
                            <a href="<?php echo BASE_URL; ?>/obat/delete/<?php echo $obat['id_obat']; ?>" 
