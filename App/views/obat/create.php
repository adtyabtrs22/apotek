<!-- File: app/views/obat/create.php -->
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/obat/create">
                ...
                <select name="id_jenis_obat" required>
                    ...
                    <?php foreach ($data['jenis_obat'] as $jenis): ?>
                        <option value="<?php echo $jenis['id_jenis_obat']; ?>"><?php echo htmlspecialchars($jenis['jenis_obat']); ?></option>
                    <?php endforeach; ?>
                </select>
                ...
                <select name="id_kategori" required>
                    ...
                    <?php foreach ($data['kategori_obat'] as $kategori): ?>
                        <option value="<?php echo $kategori['id_kategori']; ?>"><?php echo htmlspecialchars($kategori['kategori']); ?></option>
                    <?php endforeach; ?>
                </select>
                ...
                <select name="id_satuan" required>
                    ...
                    <?php foreach ($data['satuan'] as $satuan): ?>
                        <option value="<?php echo $satuan['id_satuan']; ?>"><?php echo htmlspecialchars($satuan['satuan']); ?></option>
                    <?php endforeach; ?>
                </select>
                ...
                <button type="submit"><i class="fas fa-save"></i> Tambah Obat</button>
            </form>
        </div>
    </div>
    <!-- JavaScript -->
