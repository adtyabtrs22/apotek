...
<head>
    ...
    <title>Master Kategori Obat - Apotek</title>
...
<body>
    ...
    <div class="content" style="margin-top: 20px;">
        <a href="<?php echo BASE_URL; ?>/kategori_obat/create" class="button">Tambah Kategori Obat</a>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
    ...
    <?php foreach ($data['kategori_obat'] as $kategori): ?>
        <tr>
            ...
            <td>
                <a href="<?php echo BASE_URL; ?>/kategori_obat/edit/<?php echo $kategori['id_kategori'] ?? '#'; ?>"></i> Edit</a> |
                <a href="<?php echo BASE_URL; ?>/kategori_obat/delete/<?php echo $kategori['id_kategori'] ?? '#'; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"></i> Delete</a>
            </td>
        </tr>
            <?php endforeach; ?>
            <?php else: ?>
            <tr>
                <td colspan="3">Tidak ada data kategori obat.</td>
            </tr>
        <?php endif; ?>
            </tbody>
        </table>
