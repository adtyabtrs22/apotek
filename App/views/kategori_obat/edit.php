...
<head>
    ...
    <title>Edit Kategori Obat - Apotek</title>
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/kategori_obat/edit/<?php echo $data['kategori_obat']['id_kategori']; ?>">

                <label for="kategori">Nama Kategori:</label>
                <input type="text" name="kategori" value="<?php echo htmlspecialchars($data['kategori_obat']['kategori']); ?>" required>
