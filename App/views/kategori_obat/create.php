...
<head>
    ...
    <title>Tambah Kategori Obat - Apotek</title>
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/kategori_obat/create">
                <label for="kategori">Nama Kategori:</label>
                <input type="text" name="kategori" placeholder="Masukkan nama kategori obat" required>

                <button type="submit"><i class="fas fa-save"></i> Tambah Kategori</button>
            </form>
        </div>
    </div>
    <!-- JavaScript -->
