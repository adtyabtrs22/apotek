...
<head>
    ...
    <title>Tambah Jenis Obat - Apotek</title>
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/jenis_obat/create">
                <label for="jenis_obat">Nama Jenis Obat:</label>
                <input type="text" name="jenis_obat" placeholder="Masukkan nama jenis obat" required>

                <button type="submit"><i class="fas fa-save"></i> Tambah Jenis</button>
            </form>
        </div>
    </div>
    <!-- JavaScript -->
