...
<head>
    ...
    <title>Edit Jenis Obat - Apotek</title>
...
<body>
    ...
    <div class="form-container">
        ...
        <?php if (!empty($data['error'])): ?>
            <div style="color: red; margin-bottom: 10px;"><?php echo $data['error']; ?></div>
        <?php endif; ?>
        <form method="POST" action="<?php echo BASE_URL; ?>/jenis_obat/edit/<?php echo $data['jenis_obat']['id_jenis_obat']; ?>">
            <label for="jenis_obat">Nama Jenis Obat:</label>
            <input type="text" name="jenis_obat" value="<?php echo htmlspecialchars($data['jenis_obat']['jenis_obat']); ?>" placeholder="Masukkan nama jenis obat" required>
            <button type="submit"><i class="fas fa-save"></i> Update Jenis</button>
        </form>
    </div>
</div>
    <!-- JavaScript -->
