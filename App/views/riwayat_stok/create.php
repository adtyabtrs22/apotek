...
<head>
    ...
    <title>Tambah Riwayat Stok - Apotek</title>
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/riwayat_stok/create">
                ...
                <input type="number" name="stok_akhir" min="0" required>

                <button type="submit"><i class="fas fa-save"></i> Tambah Riwayat Stok</button>
            </form>
        </div>
    </div>
    <!-- JavaScript -->
