...
<head>
    ...
    <title>Tambah Detail Pemeriksaan Stok - Apotek</title>
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            <h2>Tambah Detail Pemeriksaan Stok</h2>
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/detail_pemeriksaan_stok/create">
                ...
                <select name="id_pemeriksaan" required>
                    ...
                    <?php foreach ($data['pemeriksaan_stok'] as $pemeriksaan): ?>
                        <option value="<?php echo $pemeriksaan['id_pemeriksaan']; ?>"><?php echo htmlspecialchars($pemeriksaan['tanggal_pemeriksaan']); ?></option>
                    <?php endforeach; ?>
                </select>
                ...
                <input type="number" name="stok_tercatat" min="0" required>

                <label for="stok_fisik">Stok Fisik:</label>
                <input type="number" name="stok_fisik" min="0" required>

                <button type="submit"><i class="fas fa-save"></i> Tambah Detail Pemeriksaan</button>
            </form>
        </div>
    </div>
    <!-- JavaScript -->
