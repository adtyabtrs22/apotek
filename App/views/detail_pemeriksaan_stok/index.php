...
<head>
    ...
    <title>Manajemen Detail Pemeriksaan Stok - Apotek</title>
...
<body>
    ...
    <div class="content" style="margin-top: 20px;">
        <a href="<?php echo BASE_URL; ?>/detail_pemeriksaan_stok/create" class="button">Tambah Detail Pemeriksaan Baru</a>
        <center><h2>Detail Pemeriksaan Baru</h2></center>
        <table>
            <thead>
                <tr>
                    <th>ID Detail</th>
            ...
            <tbody>
                <?php foreach($data['detail_pemeriksaan_stok'] as $detail): ?>
                    <tr>
                        <td><?php echo htmlspecialchars($detail['id_detail']); ?></td>
                        <td><?php echo htmlspecialchars($detail['tanggal_pemeriksaan']); ?></td>
                        <td><?php echo htmlspecialchars($detail['nama_obat']); ?></td>
                        <td><?php echo htmlspecialchars($detail['stok_tercatat']); ?></td>
                        <td><?php echo htmlspecialchars($detail['stok_fisik']); ?></td>
                        <td><?php echo htmlspecialchars($detail['selisih']); ?></td>
                        <td>
                            <a href="<?php echo BASE_URL; ?>/detail_pemeriksaan_stok/edit/<?php echo $detail['id_detail']; ?>">Edit</a> |
                            <a href="<?php echo BASE_URL; ?>/detail_pemeriksaan_stok/delete/<?php echo $detail['id_detail']; ?>" 
                               onclick="return confirm('Apakah Anda yakin ingin menghapus detail ini?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php if(empty($data['detail_pemeriksaan_stok'])): ?>
                    <tr>
                        <td colspan="7">Tidak ada data detail pemeriksaan stok.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
