...
<body>
    ...
    <center><h2>Manajemen Pengguna</h2></center>
        <a href="<?php echo BASE_URL; ?>/users/create" class="button">Tambah Pengguna Baru</a>
        <table>
            <thead>
                <tr>
                    <th>ID User</th>
            ...
            <tbody>
                <?php foreach($data['users'] as $user): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo BASE_URL; ?>/users/edit/<?php echo $user['id_user']; ?>">Edit</a> |
                            <a href="<?php echo BASE_URL; ?>/users/delete/<?php echo $user['id_user']; ?>" 
