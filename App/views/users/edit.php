...
<head>
    ...
    <title>Edit Pengguna - Apotek</title>
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            <h2>Edit Pengguna</h2>
            <form method="POST" action="<?php echo BASE_URL; ?>/users/edit/<?php echo $data['user']['id_user'] ?? ''; ?>">
                <label for="nama_user">Nama:</label>
                <input type="text" name="nama_user" value="<?php echo htmlspecialchars($data['user']['nama_user'] ?? ''); ?>" required>

                <label for="jabatan">Jabatan:</label>
                <select name="jabatan" required>
                    <option value="">-- Pilih Jabatan --</option>
                    <option value="admin" <?php echo (isset($data['user']['jabatan']) && $data['user']['jabatan'] == 'admin') ? 'selected' : ''; ?>>Admin</option>
                    <option value="apoteker" <?php echo (isset($data['user']['jabatan']) && $data['user']['jabatan'] == 'apoteker') ? 'selected' : ''; ?>>Apoteker</option>
                </select>

                <label for="username">Username:</label>
                <input type="text" name="username" value="<?php echo htmlspecialchars($data['user']['username'] ?? ''); ?>" required>
                ...
                <button type="submit"><i class="fas fa-save"></i> Update Pengguna</button>
            </form>
        </div>
    </div>
    <!-- JavaScript -->
