...
<head>
    ...
    <title>Edit Pemeriksaan Stok - Apotek</title>
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/pemeriksaan_stok/edit/<?php echo $data['pemeriksaan_stok']['id_pemeriksaan']; ?>">
                <label for="tanggal_pemeriksaan">Tanggal Pemeriksaan:</label>
                <input type="date" name="tanggal_pemeriksaan" value="<?php echo htmlspecialchars($data['pemeriksaan_stok']['tanggal_pemeriksaan']); ?>" required>

                <label for="id_user">Pemeriksa:</label>
                <select name="id_user" required>
                    <option value="">-- Pilih Pengguna --</option>
                    <?php foreach ($data['pengguna'] as $pengguna): ?>
                        <option value="<?php echo $pengguna['id_user']; ?>" <?php echo ($data['pemeriksaan_stok']['id_user'] == $pengguna['id_user']) ? 'selected' : ''; ?>>
                ...
                <textarea name="keterangan" rows="4"><?php echo htmlspecialchars($data['pemeriksaan_stok']['keterangan']); ?></textarea>
